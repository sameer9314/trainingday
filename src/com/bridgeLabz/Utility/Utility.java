...
/**********************************Find Percentage of Head vs Tails*********************************************************************************************/	
		/*
...
/*******************************************Replace String******************************************************************************************/		
		...
		board[0][0]='x';
		  ...
		  * 
		  * @return templates after replacihttps://github.com/sameer9314/trainingday.gitng the <<userName>> from the template with the entered String.
		  */
...
//	  		}
	  		...
	  		while(Tic­Tac­Toe.valueEntered==false) {
	  			...
	  			if(Utility.checkEmptyIndex(row,col)==true) {
	  				...
	  				System.out.println();
	  				if(Tic­Tac­Toe.countValueEntered!=9) System.out.println("Computer turn");
	  			}
	  			else {
...
//	  	}
	  	...
	  	while(Tic­Tac­Toe.valueEntered==false) {
	  		...
	  		if(Utility.checkEmptyIndex(row,col)==true) {
	  			...
	  			Tic­Tac­Toe.valueEntered=true;
	  			Utility.printBoard(Tic­Tac­Toe.board);
	  			if(Tic­Tac­Toe.countValueEntered!=9)  System.out.println("User turn");
	  		}
	  	}
	  	Tic­Tac­Toe.valueEntered=false;
	  	// && breakPoint==false
	  ...
	  /******************************************************************************************************************************************/	
	  	 public static boolean checkEmptyIndex(int row,int col) {
	  		 if(Tic­Tac­Toe.board[row][col]=='n') {
	  			return true;
	  		 }
	  		 else {
	  			return false;
	  ...
	  public static void findWinner(char board[][]) {
	  	...
	  	if(board[0][0]==Tic­Tac­Toe.user && board[0][1]==Tic­Tac­Toe.user && board[0][2]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][0]==Tic­Tac­Toe.comp && board[0][1]==Tic­Tac­Toe.comp && board[0][2]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  	...
	  	if(board[1][0]==Tic­Tac­Toe.user&& board[1][1]==Tic­Tac­Toe.user && board[1][2]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[1][0]==Tic­Tac­Toe.comp && board[1][1]==Tic­Tac­Toe.comp && board[1][2]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("Computer wins");
	  			System.exit(0);
	  		}
	  	...
	  	if(board[2][0]==Tic­Tac­Toe.user && board[2][1]==Tic­Tac­Toe.user && board[2][2]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[2][0]==Tic­Tac­Toe.comp && board[2][1]==Tic­Tac­Toe.comp && board[2][2]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("User wins");
	  			System.exit(0);
	  		}
	  /************************************************************************************************/	
	  	if(board[0][0]==Tic­Tac­Toe.user && board[1][0]==Tic­Tac­Toe.user && board[2][0]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][0]==Tic­Tac­Toe.comp && board[1][0]==Tic­Tac­Toe.comp && board[2][0]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("Computer wins");
	  			System.exit(0);
	  		}	
	  	...
	  	if(board[0][1]==Tic­Tac­Toe.user && board[1][1]==Tic­Tac­Toe.user && board[2][1]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][1]==Tic­Tac­Toe.comp && board[1][1]==Tic­Tac­Toe.comp && board[2][1]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("Computer wins");
	  			System.exit(0);
	  		}
	  	...
	  	if(board[0][2]==Tic­Tac­Toe.user && board[1][2]==Tic­Tac­Toe.user && board[2][2]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][1]==Tic­Tac­Toe.comp && board[1][2]==Tic­Tac­Toe.comp && board[2][2]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("User wins");
	  			System.exit(0);
	  		}	
	  /*******************************************************************************************/	
	  	if(board[0][0]==Tic­Tac­Toe.user && board[1][1]==Tic­Tac­Toe.user && board[2][2]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][0]==Tic­Tac­Toe.comp && board[1][1]==Tic­Tac­Toe.comp && board[2][2]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("User wins");
	  			System.exit(0);
	  		}
	  /*******************************************************************************************/	
	  	if(board[0][2]==Tic­Tac­Toe.user && board[1][1]==Tic­Tac­Toe.user && board[2][0]==Tic­Tac­Toe.user) {
	  		...
	  		if(board[0][2]==Tic­Tac­Toe.comp && board[1][1]==Tic­Tac­Toe.comp && board[2][0]==Tic­Tac­Toe.comp) {
	  			Utility.printBoard(board);
	  			System.out.println("User wins");
	  			System.exit(0);
	  		}	
